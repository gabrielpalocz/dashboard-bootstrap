...
let emailClassName = 'form-control email shadow-none rounded-4';
...
let passwordCardClassName = 'card rounded-4 border';
                        ...
                        <div className="d-grid gap-3 p-2">
                            <div className="form-floating">
                                ...
                                {touched.email && errors.email ? (
                                    ...
                                    emailClassName = 'form-control email shadow-none rounded-4';
                            ...
                            <div class={passwordCardClassName} >
                                <div class="card-body d-flex justify-content-center p-0">
                                    <div class="input-group has-validation">
                                        ...
                                        <span className="input-group-text rounded-4 border border-0" style={{ backgroundColor: 'white' }}> <span className="nav-link" role="button" onClick={toggle} >{isVisible ? <AiOutlineEyeInvisible /> : <AiOutlineEye /> }</span></span>
                                    </div>
                                </div>
                            </div>
