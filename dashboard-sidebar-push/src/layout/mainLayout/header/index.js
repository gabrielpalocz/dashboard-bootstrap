                ...
                <li className="nav-item">
                    <div className='d-flex align-items-center ms-3' >
                        ...
                        <div className={width >= 768 ? 'ms-5' : 'ms-2'} >
                            <button className="btn btn-outline-primary btn-sm border-0 rounded-3 mt-1" id='butons' type="button" onClick={handleClick} data-bs-target={width >= 768 ? "" : "#offcanvasNavbar"} data-bs-toggle={width >= 768 ? "" : "offcanvas"} style={{ '--bs-btn-bg': '#eef2f6' }}>
                                <IconMenu2 />
                            </button>
                        </div>
                    </div>
